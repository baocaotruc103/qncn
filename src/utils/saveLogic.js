...
function collectHoSoPayload(hoSoId) {
    ...
    return {
        ...
        gioi_tinh: getValueFromControls(tab1, 2),
        don_vi: getValueFromControls(tab1, 3),
        thang_nam_vao_quan_doi: getValueFromControls(tab1, 4),
        so_cmqncn_cmsq: getValueFromControls(tab1, 5),
        ngay_cap_cmqncn_cmsq: getValueFromControls(tab1, 6),
        noi_cap_cmqncn_cmsq: getValueFromControls(tab1, 7),
        que_quan: getValueFromControls(tab1, 8),
        nhom_mau: getValueFromControls(tab1, 9),
        so_cccd: getValueFromControls(tab1, 10),
        ngay_cap_cccd: getValueFromControls(tab1, 11),
        noi_cap_cccd: getValueFromControls(tab1, 12),
        han_su_dung_cccd: getValueFromControls(tab1, 13),
        trinh_do_ngoai_ngu: getValueFromControls(tab1, 14),
        khoi_quan: getValueFromControls(tab1, 15),
        ho_ten_thuong_dung: getValueFromControls(tab1, 16),
        tinh_trang_hon_nhan: getValueFromControls(tab1, 17),
        noi_thuong_tru: getValueFromControls(tab1, 18),
        noi_thuong_tru_chi_tiet: getValueFromControls(tab1, 19),
        noi_tam_tru: getValueFromControls(tab1, 20),
        noi_tam_tru_chi_tiet: getValueFromControls(tab1, 21),
        noi_o_hien_tai: getValueFromControls(tab1, 22),
        noi_o_hien_tai_chi_tiet: getValueFromControls(tab1, 23),
        tn_tuyen_dung: getValueFromControls(tab1, 24),
        tn_nhap_ngu: getValueFromControls(tab1, 25),
        tn_xuat_ngu: getValueFromControls(tab1, 26),
        tn_tai_ngu: getValueFromControls(tab1, 27),
        tn_hsq_bs_sang_qncn: getValueFromControls(tab1, 28),
        tn_hsq_bs_sang_cnvqp: getValueFromControls(tab1, 29),
        tn_cnvqp_sang_qncn: getValueFromControls(tab1, 30),
        ngay_vao_doan: getValueFromControls(tab1, 31),
        ngay_vao_dang: getValueFromControls(tab1, 32),
        ngay_chinh_thuc_dang: getValueFromControls(tab1, 33),
